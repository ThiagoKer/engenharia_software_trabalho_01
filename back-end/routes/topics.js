...
// GET /topics
// Lista tópicos com filtros opcionais
// Query params:
...
// GET /topics/:id
// Retorna detalhes completos de um tópico específico
// Inclui: título, conteúdo, autor, categoria, likes, comentários
// Retorna erro 404 se tópico não existe
...
// Valida profanidade (validarConteudo)
// Body esperado:
// titulo_topico: string
// categoria_topico: slug da categoria
// conteudo_topico: string
...
// PUT /topics/:id
// Edita tópico existente
//  Validações:
// Apenas autor ou admin podem editar
// Categoria deve ser válida
// Conteúdo passa por filtro de profanidade
...
// POST /topics/:id/like
// Toggle de like em tópico (curtir/descurtir)
// Requer autenticação 
// Lógica:
// Se já é curtido pelo usuário: remove like
// Se não é curtido: adiciona like
...
// Lista todos os comentários do tópico
// Ordenado cronologicamente (comentários mais antigos primeiro)
// Retorna:
// id: ID do comentário
// content: Texto do comentário
// username: Autor do comentário
...
// Adiciona comentário a um tópico
// Requer autenticação
